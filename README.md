...
[![Build Status](https://travis-ci.org/digitallumens/sql-migrate.svg?branch=master)](https://travis-ci.org/digitallumens/sql-migrate) [![GoDoc](https://godoc.org/github.com/digitallumens/sql-migrate?status.png)](https://godoc.org/github.com/digitallumens/sql-migrate)
...
```bash
go get github.com/digitallumens/sql-migrate/...
```
...
```go
import "github.com/digitallumens/sql-migrate"
```
...
Check [the GoDoc reference](https://godoc.org/github.com/digitallumens/sql-migrate) for the full documentation.
